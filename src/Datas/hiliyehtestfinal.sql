...
-- -----------------------------------------------------
-- Schema hiliyehtestfinal
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema hiliyehtestfinal
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `hiliyehtestfinal` DEFAULT CHARACTER SET latin1 ;
USE `hiliyehtestfinal` ;

-- -----------------------------------------------------
-- Table `hiliyehtestfinal`.`fos_user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hiliyehtestfinal`.`fos_user` (
...
-- -----------------------------------------------------
-- Table `hiliyehtestfinal`.`article`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hiliyehtestfinal`.`article` (
  ...
  CONSTRAINT `fk_article_fos_user`
    ...
    REFERENCES `hiliyehtestfinal`.`fos_user` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `hiliyehtestfinal`.`section`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hiliyehtestfinal`.`section` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `theTitle` VARCHAR(45) NULL,
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
-- Table `hiliyehtestfinal`.`section_has_article`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hiliyehtestfinal`.`section_has_article` (
  ...
  CONSTRAINT `fk_section_has_article_section1`
    ...
    REFERENCES `hiliyehtestfinal`.`section` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_section_has_article_article1`
    FOREIGN KEY (`article_id`)
    REFERENCES `hiliyehtestfinal`.`article` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
